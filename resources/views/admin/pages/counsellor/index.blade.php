                ...
                <table class="table table-bordered  table-md">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $translator->unhcr_number }}</td>
                            <td>{{ $translator->email }}</td>
                            <td>{{ $translator->country }}</td>
                            <td>{{ $translator->birthdate->format('F j, Y') }}</td>
                            <td>{{ Str::ucfirst($translator->sex) }}</td>
                            <td>
                                <a href="#"
                                ...
                                <a href="{{ route('admin.translator.show', $translator->id) }}"
